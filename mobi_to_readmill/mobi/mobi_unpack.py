...
def unpack_book(infile, outdir):
        ...
        data += '<package version="2.0" xmlns="http://www.idpf.org/2007/opf" unique-identifier="BookId">\n'
        data += '  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:opf="http://www.idpf.org/2007/opf">\n'
        ...
        data += '    <dc:identifier id="BookId">' + metadata.get('UniqueID',0) + '</dc:identifier>\n'
        if 'Creator' in metadata:
          data += '    <dc:creator opf:role="aut">'+metadata.get('Creator')+'</dc:creator>\n'
